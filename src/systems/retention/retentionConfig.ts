...
/**
 * Return reminders for scrap-shift.
 *
...
export const returnReminders = createReturnReminders({
    idPrefix: "scrap-shift",
    reminders: () => [
        {
            id: "d1",
            title: "Your daily cache is ready",
            body: "Claim the scrap before the horde resets.",
            delaySeconds: RETURN_DELAYS_SECONDS[0],
        },
        {
            id: "d2",
            title: "Your streak is still alive",
            body: "One shift today keeps the daily drop chain going.",
            delaySeconds: RETURN_DELAYS_SECONDS[1],
        },
        {
            id: "d3",
            title: "The yard is quiet",
            body: "Your upgrades are still equipped and waiting.",
